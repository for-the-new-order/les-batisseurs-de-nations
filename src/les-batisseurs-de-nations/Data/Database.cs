    ...
    public class Database
    {
        ...
        public void Seed()
        {
            ...
            var kilmi = AddPlayer(new(
                ...
                ProfileImageUri: "https://cdn.rpg.solutions/les-batisseurs-de-nations/images/players/members/Kilmi-Token.jpeg",
            ...
            Episodes.Add(new(
                ...
                Players: new[] { mamita, gur, kilmi, dhanlbek, nalvyna },
                JournalEntries: new[]
                {
                    new JournalEntry(
                        Author: mamita,
                        WrittenDate: new(2021, 7, 11),
            ...
            Episodes.Add(new(
                ...
                Players: new[] { gur, kilmi, dhanlbek },
